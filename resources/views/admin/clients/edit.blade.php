            ...
            <form action="{{ route('admin.clients.update', $client->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('contact') is-invalid @enderror" id="contact" name="contact" value="{{ old('contact', $client->contact) }}" required>
                        @error('contact')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('secteur') is-invalid @enderror" id="secteur" name="secteur" value="{{ old('secteur', $client->secteur) }}" required>
                        @error('secteur')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <p class="text-muted">Leave the password fields blank if you don't want to change the password.</p>
                    {{-- Password --}}
                    <div class="col-md-6 mb-3">
